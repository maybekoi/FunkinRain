...
class DigitDisplay extends FlxSpriteGroup
{
	...
	public function new(_x:Float, _y:Float, _path:String, _digitCount:Int, ?_scale:Float = 1, ?_spacing:Float = 0, ?_startingNumber:Int = 0,
			?_hideTrailingZeroes:Bool = false)
	{
		super(_x, _y);
